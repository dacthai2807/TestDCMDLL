...
bool convertDcmToBMPWC(const wchar_t* dcmFilename, const char* bmpFilename) {
	DcmFileFormat dfile;
	OFCondition cond = dfile.loadFile(dcmFilename);
...
bool convertDcmToJPGWC(const wchar_t* dcmFilename, const char* jpgFilename) {
	DcmFileFormat dfile;
	OFCondition cond = dfile.loadFile(dcmFilename);
...
bool convertDcmToPNGWC(const wchar_t* dcmFilename, const char* pngFilename) {
	DcmFileFormat dfile;
	OFCondition cond = dfile.loadFile(dcmFilename);
